...
#include "../go/GoPlayerMove.h"
#include "../smartgame/SgArray.h"
...
#include "../smartgame/SgPointIterator.h"
...
private:
    ...
    public:
        ...
        typedef SgArrayList<SgPoint, SG_MAX_ONBOARD + 1>::Iterator StoneIterator;
