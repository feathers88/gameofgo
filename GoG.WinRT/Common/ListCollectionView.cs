...
namespace GoG.WinRT.Common
{
        ...
        IComparer<object>
    {
        ...
        void HandleItemChanged(object item)
        {
            ...
            bool refresh = _filter != null && !_filter(item);
            if (_sort.Count > 0)
            {
        ...
        public bool MoveCurrentTo(object item) { return item == CurrentItem || MoveCurrentToIndex(IndexOf(item)); }
