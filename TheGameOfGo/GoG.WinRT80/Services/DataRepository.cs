...
using GoG.WinRT80.FuegoService;
using GoG.WinRT80.MessengerService;
using Microsoft.Practices.Prism.StoreApps.Interfaces;

namespace GoG.WinRT80.Services
{
    public class DataRepository : IDataRepository
    {
        ...
        private FuegoServiceClient GetFuegoClient()
        {
            ...
            // On developement machines, a HOSTS file entry should be created to point cbordeman.chickenkiller.com to 127.0.0.1
            // for debugging purposes.
            var client = new FuegoServiceClient(binding, new EndpointAddress("http://cbordeman.chickenkiller.com/GoG.Services/fuego.svc"));
        ...
        private MessengerClient GetMessengerClient()
        {
            ...
            // for debugging purposes.
            var client = new MessengerClient(binding, new EndpointAddress("http://cbordeman.chickenkiller.com/GoG.Services/messenger.svc"));
