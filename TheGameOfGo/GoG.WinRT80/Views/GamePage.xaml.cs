...
namespace GoG.WinRT80.Views
{
    ...
    /// </summary>
    public sealed partial class GamePage: IDataContextChangedHandler<GamePage>
    {
        public GamePage()
        {
            this.InitializeComponent();
            this.SizeChanged += OnSizeChanged;
            DataContextChangedHelper<GamePage>.Bind(this);
        }
        
        private GamePageViewModel _viewModel;

        public void DataContextChanged(GamePage sender, DependencyPropertyChangedEventArgs e)
        {
        ...
        private void BottomAppBar_OnOpened(object sender, object e)
        {
