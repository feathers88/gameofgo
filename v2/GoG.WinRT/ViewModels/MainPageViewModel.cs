...
namespace GoG.WinRT.ViewModels
{
    public class MainPageViewModel : PageViewModel
    {
        ...
        #region NovaGSCommand
        DelegateCommand _novaGSCommand;
        public DelegateCommand NovaGSCommand
        {
            get { if (_novaGSCommand == null) _novaGSCommand = new DelegateCommand(ExecuteNovaGS, CanNovaGS); return _novaGSCommand; }
        }
        public bool CanNovaGS()
        {
            return true;
        }
        public void ExecuteNovaGS()
        {
            NavService.Navigate("NovaGSHome", null);
        }
        #endregion NovaGSCommand
