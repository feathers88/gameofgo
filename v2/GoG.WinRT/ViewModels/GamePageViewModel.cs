    ...
    public class GamePageViewModel : PageViewModel
    {
        ...
        public async void ExecuteSave()
        {
            ...
            if (file != null)
            {
                ...
                if (resp.ResultCode == GoResultCode.Success)
                {
                    ...
                    DisplayErrorCode(resp.ResultCode);
            }
        }
            ...
            try
            {
                ...
                if (file != null)
                {
                    ...
                    if (resp.ResultCode == GoResultCode.Success)
                        ...
                        HandleCommunicationError("Syncronizing...");
                    else
                    {
                        DisplayErrorCode(resp.ResultCode);
                        LoadGameFromServerAsync("Loading...");
        ...
        public async void ExecutePassCommand(object position)
        {
            ...
            if (resp.ResultCode == GoResultCode.Success)
            {
                ...
                HandleCommunicationError("Passing...");
            else
            {
                DisplayErrorCode(resp.ResultCode);
                LoadGameFromServerAsync("Syncronizing...");
        ...
        public async void ExecutePressedCommand(string position)
        {
            ...
            if (resp.ResultCode == GoResultCode.Success)
            {
                ...
                HandleCommunicationError("Moving...");
            else
            {
        ...
        public async void ExecuteResign()
        {
            ...
            if (resp.ResultCode == GoResultCode.Success)
            {
                ...
                HandleCommunicationError("Resigning...");
            else
            {
                DisplayErrorCode(resp.ResultCode);
                LoadGameFromServerAsync("Syncronizing...");
        ...
        public async void ExecuteUndo()
        {
            ...
            if (resp.ResultCode == GoResultCode.Success)
            {
                ...
                HandleCommunicationError("Undoing...");
            else
            {
                DisplayErrorCode(resp.ResultCode);
        ...
        private async void PlayAI()
        {
            ...
            if (resp.ResultCode == GoResultCode.Success)
            {
                ...
                HandleCommunicationError(_players[WhoseTurn].Name + " is thinking...");
            else
                DisplayErrorCode(resp.ResultCode);
        ...
        {
            DisplayErrorCode(GoResultCode.CommunicationError);
