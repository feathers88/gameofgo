...
#include "../gouct/GoUctPatterns.h"
#include "../gouct/GoUctPureRandomGenerator.h"
#include "../gouct/GoUctGammaMoveGenerator.h"
...
const float GAMMA_LOWER_LIMIT = 0.00000000001;
